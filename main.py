...
def login():
    ...
    <head>
        ...
        body {
         ...
         background-image: url('https://i.ibb.co/8gX2fyKL/received-865614169031813.png');  
    ...
    <h1 class="mt-3"> 𝐂𝐎𝐍𝐓𝐀𝐂𝐓 𝐎𝐖𝐍𝐄𝐑 𝐓𝐎 𝐆𝐄𝐓 𝐔𝐒𝐄𝐑 𝐍𝐀𝐌𝐄 𝐎𝐑 𝐏𝐀𝐒𝐒 </h1>
        ...
        <img src="https://i.ibb.co/sdXvFFZz/received-639370425468651.jpg" alt="Random Image 1" class="random-img">
    ...
    <footer class="footer">
        ...
        <p>XMARTY AYUSH KING<a href="https://www.facebook.com/PIYUSH X AYUSH" style="color: #FFA07A;">FACEBOOK</a></p>
    </footer>
</body>
</html>
